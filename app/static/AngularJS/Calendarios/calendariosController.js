registrationModule.controller('calendariosController', function($scope, $rootScope, alertFactory, uiGridGroupingConstants, utils, uiGridConstants) {
    ...
    $scope.today = function() {
        $rootScope.dtini = new Date();
        $rootScope.dtfin = new Date();
    };
